...
4. Визуализации предсказанных состояний
...
Предсказание состояний для записи ЭКГ. Сигнал разбивается на сегменты по 10 секунд с перекрытием, после чего соседние сегменты с одинаковыми предсказаниями объединяются.
...
Для визуализации предсказанных состояний используйте функцию `plot_predictions` из `notebooks/manual_api_testing.ipynb`, как здесь:

![visualization_example1748864159524](images/README/visualization_example.png)
